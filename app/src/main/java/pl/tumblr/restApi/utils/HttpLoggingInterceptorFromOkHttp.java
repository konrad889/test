...
public class HttpLoggingInterceptorFromOkHttp implements Interceptor {
    ...
    public interface Logger {
        ...
        Logger DEFAULT = new Logger() {
            ...
            public void log(String message) {
                formatedLogs(message);
//                Platform.get().log(message);
            }
        };
    }

    public HttpLoggingInterceptorFromOkHttp() {
        this(Logger.DEFAULT);
    }

    public HttpLoggingInterceptorFromOkHttp(Logger logger) {
        this.logger = logger;
    }
    ...
    public static void formatedLogs(Object source) {
        String tag = "";
...
//        tag = " " + tag + " ";
//        System.out.println(" ");
//        System.out.println(getSplitter(50) + tag + getSplitter(50));
//        System.out.println("" + source);
//        System.out.println(getSplitter(100 + tag.length()));
//        System.out.println(" ");

        Platform.get().log("" + source);
    }
